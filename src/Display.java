...
public class Display extends Canvas
{
    ...
    public Display(int width, int height, String title)
    {
        ...
        System.out.println("mframe" + m_frame.getWidth());
        System.out.println("mframebuf" + m_frameBuffer.GetWidth());
    }

    public void drawPixel(int x, int y) {
        m_frameBuffer.DrawPixel(x, y, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0xFF);
    }
